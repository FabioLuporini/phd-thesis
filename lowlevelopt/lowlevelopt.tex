...
\end{equation}
\caption{The Helmholtz bilinear form. The trial function $u$ and the test function $v$ belong to the space of continuous piecewise-defined polynomials of given degree.}
...
\int_\Omega \nabla u\cdot\nabla v\ \mathrm{d}x
\end{equation}
\caption{The Diffusion bilinear form. The trial function $u$ and the test function $v$ belong to the space of continuous piecewise-defined polynomials of given degree.}
...
\end{equation}
\caption{The Burgers operator. The solution $u$ and the test function $v$ belong to the space of vector-valued continuous piecewise-defined polynomials of given degree. $\nu$ is a constant scalar viscosity. A backward Euler time discretization is used.}
