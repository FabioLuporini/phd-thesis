...
\makebox[\textwidth][c]
{
\begin{tabulary}{1.0\columnwidth}{M{1.2cm} V{4} M{2.0cm} | M{7.2cm} | M{1.7cm} N}
\hline
...
\hline
\multirow{2}{*}{$n$} & \multirow{2}{*}{$h$}  & \multicolumn{4}{c V{4}}{$d$ {\tt velocity}} & \multicolumn{4}{c}{$d$ {\tt stress}} & \\[4pt] \cline{3-11}
 & & $q=1$ & $q=2$ & $q=3$ & $q=4$ & $q=1$ & $q=2$ & $q=3$ & $q=4$ & \\[4pt]
\hlineB{4}
\rule{0pt}{3ex}  \multirow{2}{*}{4 (Erebus)} & 1.0 & 138k & 276k & 460k & 690k & 276k & 552k & 920k & 1379k \\[4pt]
& 1.2 & 96k & 192k & 320k & 480k & 192k & 385k & 641k & 961k \\[4pt]
\hline
\rule{0pt}{3ex}  \multirow{2}{*}{20 (CX1-Ivy)} & 0.6 & 78k & 157k & 262k & 393k & 157k & 314k & 525k & 787k  \\[4pt]
...
@ \hlineB{4}
@ \multirow{8}{*}{\shortstack{Erebus\\$(n=4)$}} & @ \multirow{4}{*}{$h=1.0$} & @ 1 & 687.96 & 596.03 & [-2,0]/[-1,0] \\ 
@ & @ & @ 2 & 1453.18 & 1200.01 & [-2,0]/[-1,0]  \\ 
@ & @ & @ 3 & 3570.21 & 2847.36 & [-2,0]/[-1,0] \\
@ & @ & @ 4 & 1 & 1 & [-2,0]/[-1,0] \\
@\cline{2-6}
@ & @ \multirow{4}{*}{$h=1.2$} & @ 1 & 419.43 & 365.39 & [-2,0]/[-1,0] \\ 
@ & @ & @ 2 & 870.14 & 715.15 & [-2,0]/[-1,0]  \\ 
@ & @ & @ 3 & 2093.56 & 1658.24 & [-2,0]/[-1,0] \\
@ & @ & @ 4 & 1 & 1 & [-2,0]/[-1,0] \\
@\hlineB{4}
@ \multirow{8}{*}{\shortstack{CX1-Ivy\\$(n=20)$}} & @ \multirow{4}{*}{$h=0.6$} & @ 1 & 1 & 1 & [-2,0]/[-1,0] \\ 
@ & @ & @ 2 & 1 & 1 & [-2,0]/[-1,0]  \\ 
@ & @ & @ 3 & 1 & 1 & [-2,0]/[-1,0] \\
@ & @ & @ 4 & 1 & 1 & [-2,0]/[-1,0] \\
@\cline{2-6}
@ & @ \multirow{4}{*}{$h=0.8$} & @ 1 & 1 & 1 & [-2,0]/[-1,0] \\ 
@ & @ & @ 2 & 1 & 1 & [-2,0]/[-1,0]  \\ 
@ & @ & @ 3 & 1 & 1 & [-2,0]/[-1,0] \\
@ & @ & @ 4 & 1 & 1 & [-2,0]/[-1,0] \\
@ \hline
