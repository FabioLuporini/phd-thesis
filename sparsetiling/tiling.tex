...
%The fusion schemes {\tt fs1}, {\tt fs2}, and {\tt fs3} do not benefit from the presence of $T_{ne}$, so by default no extra off-process data is communicated. The other fusion schemes may instead benefit from this optimization.
...
%Three fusion schemes out of six may benefit from an extended boundary region to minimize redundant computation.
\end{description}
