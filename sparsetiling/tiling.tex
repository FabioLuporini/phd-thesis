...
The flexibility of the {\em loop$\_$chain} interface, the versatility of SLOPE allowing to apply sparse tiling to arbitrary sequences of loops, and the {\em S-depth} mechanism make it possible to experiment with a variety of fusion schemes without changes to the source code. 
