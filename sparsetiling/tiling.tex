...
To overcome most of the limitations described in Section~\ref{sec:tiling:difficult} and to achieve full automation, the following strategic choices were made:
\begin{description}
