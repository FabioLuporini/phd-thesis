...
\hline
@ System & @ $h$ & @ $q$ & @ {\em OT} (s) & @ {\em OT} tiled (s) & @ $\Omega^{OT}$  \\
@ \hlineB{4}
...
\begin{spreadtab}{{tabular}{c V{4} c V{4} M{0.7cm} V{4} M{2.7cm} | M{2.7cm} V{4} M{1.5cm}}}
\hline
@ System & @ $h$ & @ $q$ & @ {\em ACT} (s) & @ {\em ACT} tiled (s) & @ $\Omega^{ACT}$  \\ 
@ \hlineB{4}
...
\begin{spreadtab}{{tabular}{c V{4} c V{4} M{0.7cm} V{4} M{2.7cm} | M{2.7cm} V{4} M{1.5cm}}}
\hline
@ System & @ $h$ & @ $q$ & @ {\em ACCT} (s) & @ {\em ACCT} tiled (s) & @ $\Omega^{ACCT}$  \\
@ \hlineB{4}
...
To motivate the performance of the various fusion schemes, PyOP2 was enhanced with a loop chain analyzer capable of estimating the best- and worst-case tile memory footprint, as well as the percentage of data reuse ideally achievable\footnote{It is part of our future plans to move this machinery at the level of SLOPE, where the effects of tile expansion can be taken into account to provide better estimates.}. 
...
It is not unreasonable to expect some of these limiting factors to arise in other applications. 

Further issues are implementation-related (point (ii) above):
