...
\begin{description}
\item[Overall completion time (OT)] Used to compute the maximum application speed-up by applying sparse tiling. 
...
To collect OT, ACT and ACCT, the following configuration was used.
\begin{itemize}
