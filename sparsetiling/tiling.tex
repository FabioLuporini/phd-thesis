...
We here show the maximum speed-ups achieved when sparse tiling is applied to Seigen on Erebus and CX1-Ivy. The maximum speed-ups were determined by picking the best execution time out of the set of tiled versions, for each node architecture, polynomial order $q$, and mesh. The search for the best tiled version is described in the next section. The results are summarized in Table~\ref{table:seigen-speedups}.
...
@ & @ & @ 4 & 1 & 1 & round([-2,0]/[-1,0],2) \\
@\hlineB{4}
@ \multirow{8}{*}{\shortstack{CX1-Ivy\\$(n=20)$}} & @ \multirow{4}{*}{$h=0.6$} & @ 1 & 1 & 1 & round([-2,0]/[-1,0],2) \\ 
@ & @ & @ 2 & 1 & 1 & round([-2,0]/[-1,0],2)  \\ 
@ & @ & @ 3 & 1 & 1 & round([-2,0]/[-1,0],2) \\
@ & @ & @ 4 & 1 & 1 & round([-2,0]/[-1,0],2) \\
@\cline{2-6}
@ & @ \multirow{4}{*}{$h=0.8$} & @ 1 & 1 & 1 & round([-2,0]/[-1,0],2) \\ 
@ & @ & @ 2 & 1 & 1 & round([-2,0]/[-1,0],2)  \\ 
@ & @ & @ 3 & 1 & 1 & round([-2,0]/[-1,0],2) \\
@ & @ & @ 4 & 1 & 1 & round([-2,0]/[-1,0],2) \\
@ \hline
