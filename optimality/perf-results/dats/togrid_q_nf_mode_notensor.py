...
for ax, ((nf, q), vals) in zip(grid, sorted(_timings.items())):
    ...
    # Plot parameters
    # We are going to show the speedup of /ffc_quad/, /uflacs/, /coffee_O1/, /coffee_O4/ over /plain/, so N = 4
    N = 4
    ...
    # Plot
    tick_names = (r'quad', r'ufls', r'cfO1', r'cfO2')
    ...
    # Compute speed ups
    p = plain
    speedups = (p/ffc_quad, p/uflacs, p/coffee_O1, p/coffee_O4)
    # Draw the bars
...
plt.text(-6.2, y0, r'Polynomial degree $q$')
plt.text(-14.4, y1, r'Speedup relative to fully inlined expression', rotation='vertical')
