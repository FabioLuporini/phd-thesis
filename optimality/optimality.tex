...
\subsection{The dichotomy between Sharing Elimination and Common Sub-expressions Elimination}
%TODO CSE
Common sub-expressions elimination (CSE) is a transformation that aims to reduce the operation count in a code region. It consists of searching identical sub-expressions that reduce to the same value and replacing them with suitable temporary variables. 

The normal form of the expressions guarantees ...
Since expressions are in normal form,  and are located within independent basic blocks. These two properties maximize the applicability of CSE: 

%TODO MCS = minimal common sub-expression
