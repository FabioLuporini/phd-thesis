...
The foundations of the thesis are thoroughly reviewed in this chapter. A top-down approach is followed. The first topic treated is the mathematical theory of the finite element method. We subsequently discuss how this theory is translated into software; in particular, we explore a revolutionary approach based upon automated code generation. The core libraries that make this approach possible are surveyed. We then dive into the state-of-the-art of performance optimization, discussing compiler- and library-based strategies. The fundamental class of loop reordering transformation is here discussed. We conclude the chapter with an overview of successful domain-specific abstractions that, to some extent, have inspired some of the core contributions of this thesis. In this journey, some of the relevant related work is introduced; each of the following chapters, however, will dedicate a whole section specifically to this matter.
