...
We introduce two spaces of functions, $U$ and $V$, called respectively trial space and test space. Informally, we can think of $U$ and $V$ as ``nice'' spaces, in which functions have desirable properties. We consider the {\em variational} or {\em weak} formulation of a linear boundary value problem\footnote{Non-linear problems require refinements that are out of the scope of this review.}
