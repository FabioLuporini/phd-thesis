...
A class of optimizations relevant for this thesis is the one based on the {\em reordering} of loop nest iterations. Well-know optimizations belonging to this class are:
