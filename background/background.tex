...
The foundations of the thesis are thoroughly reviewed in this chapter. A top-down approach is followed. The first topic treated is the mathematical theory of the finite element method. How this theory is translated into software is subsequently discussed; in particular, a revolutionary approach based upon automated code generation is explored. The core libraries that make this approach possible are surveyed. The state-of-the-art of performance optimization is then described, with emphasis on both static and dynamic strategies. The fundamental class of loop reordering transformation is here presented. An overview of the successful domain-specific abstractions that have inspired some of the core contributions of this thesis concludes the chapter. In this journey, some of the relevant related work is introduced, although extended literature review is also present in each of the following chapters..
